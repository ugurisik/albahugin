...
namespace albahugin
{
    ...
    " put  \'-\' between two values.";
        ...
        public const String SAMPLE_LINE = "ORNEK SATIR";

        #endregion

        #region MainForm

        public const string CONNECTION = "BAGLANTI";
        public const String PROGRAM = "PROGRAMLAMA";
        public const String REPORTS = "RAPORLAR";
        public const String SERVICE = "SERVIS";
        public const string CASH_REGISTER_INFO = "KASA BILGILERI";
        public const String STATUS_CHECK = "DURUM KONTROLU";
        public const String CONNECT = "BAGLANTIYI AC";
        public const String SERIAL_PORT = "SERI PORT";
        public const String COMMAND = "KOMUT";
        public const String FPU_STATE = "FPU DURUM";
        public const String RESPONSE = "CEVAP";
        public const String NEED_SERVICE = "SERVICE GEREKLI";
        public const String CONNECTION_ERROR = "BAGLANTI HATASI";
        public const String CONNECTING = "BAGLANTI ACILIYOR";
        public const String PLEASE_WAIT = "BEKLEYINIZ";
        public const String MATCHING_ERROR = "ESLEME HATASI";
        public const String DISCONNECT = "BAGLANTIYI KAPAT";
        public const string CONNECTED = "BAGLANDI";
        public const String DISCONNECTED = "BAGLANTI KAPATILDI";
        public const String CONNECTIONNOTFOUND = "BAGLANTI BULUNAMADI";
        public const String UNABLE_TO_MATCH = "ESLEME YAPILAMADI";
        public const String HARDWAREID = "SERVER ID";
